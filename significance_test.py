...
def parse_args():
    ...
    # base /group-volume/Machine-Translation/j76.jung/research-st-cr/experiments/0221_train_baseline_new_relog/checkpoint_avg_10_0309/generate-audio.tst-COMMON_st.8000.corrected.txt
    # expand /group-volume/Machine-Translation/j76.jung/research-st-cr/experiments/0228_train_baseline_new_expanded/checkpoint_avg_10_0309/generate-audio.tst-COMMON_st.8000.corrected.txt
    parser.add_argument("--compare", type=str)
    # /group-volume/Machine-Translation/j76.jung/research-st-cr/reporting-experiments/0312_en_de_base_kl_div_singularspan_10_mt_alpha_0.1/checkpoint_avg_10_0312/generate-audio.tst-COMMON_st.8000.corrected.txt
...
def main(args):
    ...
    new_stats: pd.DataFrame = get_sufficient_stats(
        translations=compare_hypo, references=labels
    )

    output = paired_bootstrap_resample(
        baseline_stats=baseline_stats,
        new_stats=new_stats,
